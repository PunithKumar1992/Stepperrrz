<%@page import="com.appfone.stepperz.Daoimpl.SadashivnagarimagesDaoimpl"%>
...
%>
    ...
    <audio autoplay hidden>
     <source src="audio/music.mp3" type="audio/mp3">
		...
		<!-- //header -->
				<!-- gallery -->
	<div class="gallery" id="gallery"><br><br><br><br>
	&nbsp;&nbsp;&nbsp;&nbsp;	<h3 class="title-w3" style="color:#313131;"> [Sadashiv Nagar]</h3>
		 <p class="sub-text"></p>
		 <% 
		SadashivnagarimagesDaoimpl sadashiv_imgobj= new SadashivnagarimagesDaoimpl();
		 size=sadashiv_imgobj.getcount();
		 sadashivnagar_images= new String[size];
		 sadashivnagar_images= sadashiv_imgobj.getSadashivnagarimages();
		 for(int i=0;i<size;i++)
		 {
			 imgname=sadashivnagar_images[i];
				imgpath="images/sadashivnagarimages/"+imgname;
		out.println("<div class='gallery-grids carouselGallery-grid hidden-xs'>");
		 out.println("<div class='col-md-4 gallery-grid' style='margin-left:4%;'>");
