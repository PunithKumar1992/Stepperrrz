<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="com.appfone.stepperz.Daoimpl.Timetable_sadashivnagrDaoimpl" %>
...
audio.play();
	...
	<!-- gallery -->
	<% 
	Timetable_sadashivnagrDaoimpl sadatime_list=new Timetable_sadashivnagrDaoimpl();
	size=sadatime_list.getTableCount();
	sada_caption=sadatime_list.getTableCaption();
	sada_images=sadatime_list.getTableImage();
	for(int i=0;i<size;i++)
	{
		img=sada_images[i];
		
		impath="images/timetable/sadhashivnagar/"+img;
