...
<section class="wrapper">
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="position-center">
                              <form:form method="post" modelAttribute="admalaim" action="saveadminmalaimg.html" enctype="multipart/form-data">
                                
                               
                               	<div class="col-md-3">

                                    <input type="file" name="adminmalafile" id="fileUpload" onchange="Upload();" value="" accept=".jpg,.png,jpeg" />
                                </div>
	...
	<div class="gallery">
		...
		<div class="gallery-grids">
				...
				<c:forEach var="malaimg" items="${adminmalaimg}">
				<c:url var="deleteadminmala" value="deleteadminmalaimg.html">
				<c:param name="delimgid" value="${malaimg.image_id}"></c:param>
				<c:param name="delimgname" value="${malaimg.image_name}"></c:param>
				</c:url>
					<div class="col-sm-4 gallery-grids">
					
					<a href="${deleteadminmala}"><i class="fa fa-trash"></i></a>
						<div class="gallery-grid" style="width:450px;height:300px;">
							<a class="example-image-link" href="images/malleshwaramimages/${malaimg.image_name }" data-lightbox="example-set" >
								<img src="images/malleshwaramimages/${malaimg.image_name }" alt="" style="width: 70%;height: 90%;" />
