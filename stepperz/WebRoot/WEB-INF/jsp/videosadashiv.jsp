<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="com.appfone.stepperz.Daoimpl.SadashivnagarvideosDaoimpl" %>
...
%>
		...
		<div class="header-w3layouts"> 
			...
			<nav class="navbar navbar-default navbar-fixed-top">
				<div class="container">
					...
					<a class="navbar-brand" href="index.jsp"><img src="images/logo.png" style="margin-top: -20%;" alt="stepperz"></a>
					</div> 
	...
	<div class="gallery" id="gallery" >
			...
			<h3 class="title-w3" style="color:white;margin-top: 10%;">Video Gallery [Sadashiv Nagar]</h3><br><br>
		 <% 
		 SadashivnagarvideosDaoimpl sada_videolist= new SadashivnagarvideosDaoimpl();
		 size=sada_videolist.getcount();
		 sadashiv_videos=sada_videolist.getSadashivnagarvideos();
		 for(int i=0;i<size;i++)
		 {
			 video_path=sadashiv_videos[i];
			 		out.println("<center>");
                    out.println("<div class='col-md-4 gallery-grid' style='width:20%;'>"); 
					 out.println("<div class='carouselGallery-col-1'>");
						out.println("<iframe src='"+video_path+"' width='267' height='300' style='border:none;overflow:hidden' scrolling='no' frameborder='0' allowTransparency='true' allowFullScreen='true'></iframe>");
		 				out.println("</div>");
						out.println("</div>");
						out.println("</center>");
